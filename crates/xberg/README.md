...
<!-- alef:hash:2af8dfbb1f563009b55f9944eb70434d421f38a3d380d8e7dc016d5161d34c1b -->
...
```toml
[dependencies]
xberg = { version = "1.1.1", features = ["pdf", "excel", "ocr"] }
```
...
```toml
xberg = { version = "1.1.1", features = ["full"] }
xberg = { version = "1.1.1", features = ["server"] }
xberg = { version = "1.1.1", features = ["cli"] }
```
...
```toml
[dependencies]
xberg = { version = "1.1.1", features = ["pdf"] }
```
