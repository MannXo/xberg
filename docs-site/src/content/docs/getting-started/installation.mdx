...
-  **Java**
  ...
  ***
  ...
  ```groovy
  implementation 'io.xberg:xberg:1.1.2'
  ```
...
-  **Kotlin Android**
  ...
  ***
  ...
  ```kotlin
  implementation("io.xberg:xberg-android:1.1.2")
  ```
...
-  **Swift**
  ...
  ***
  ...
  ```swift
  .package(url: "https://github.com/xberg-io/xberg.git", from: "1.1.2")
  ```
...
-  **Zig**
  ...
  ***
  ...
  ```bash
  zig fetch --save https://github.com/xberg-io/xberg/archive/refs/tags/v1.1.2.tar.gz
  ```
